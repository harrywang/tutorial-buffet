...
class DataGenerator(tensorflow.keras.utils.Sequence):
    ...
    def build_data(self, data_type):
        if data_type == 'train':
            self.class_data = np.load('datasets/omniglot/data/train_omniglot.npy')
        else:
            self.class_data = np.load('datasets/omniglot/data/test_omniglot.npy')
    ...
    def __data_generation(self):
        ...
        return X_sample, X_query, keras.utils.to_categorical(label)
